...
const int<19> THRESHOLD = 90000; // Threshold number of bytes to mark packet as part of a burst
/*************************************************************************
*********************** H E A D E R S  ***********************************
*************************************************************************/
  ...
  // MATCH-ACTION TBLE FOR THE PACKET COUNT
   ...
   action increment_count(){
    ...
    apply {
		...
		if(hdr.ethernet.dstAddr == 0xfa163e301ed4 || hdr.ethernet.srcAddr == 0xfa163e301ed4){
		...
		if(standard_metadata.instance_type!=0){
			...
			//ADD OPTION HEADER
			add_option_header();
                        log_msg("marker={}, count={}",{standard_metadata.packet_length,meta.min_count});

...
control MyEgress(inout headers hdr,
	...
	action mark_packet(){
		  ...
		  log_msg("flow-id = {},ingress-ts={}, egress-ts={}, deq-depth = {}, deq-bytes",
			{ meta.flowid, standard_metadata.ingress_global_timestamp,standard_metadata.egress_global_timestamp, standard_metadata.deq_qdepth, deqQdepth});
		}

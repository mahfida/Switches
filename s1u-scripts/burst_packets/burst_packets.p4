...
#define THRESHOLD 6000 // Threshold number of bytes to mark packet as part of a burst
/*************************************************************************
*********************** H E A D E R S  ***********************************
*************************************************************************/
...
control MyEgress(inout headers hdr,
        ...
        */
        ...
        action mark_packet(){
                 meta.fowid =  hdr.ipv4_inner.srcAddr ++ hdr.ipv4_inner.dstAddr 
		  ...
		  log_msg("flow-id = {},ingress-ts={}, egress-ts={}, deq-depth = {}, deq-bytes",
			{ meta.flowid, standard_metadata.ingress_global_timestamp,standard_metadata.egress_global_timestamp, 
			standard_metadata.deq_qdepth, deq_Qdepth});
	  }

        apply {  
		// bytesRemaining register value is initialized to 0 from the control plane (simple_switch_CLI)
		bytes_int = (int<19>)bytesRemaining;
                ...
                deqQdepth = (int<19>)(standard_metadata.deq_qdepth * 19w1500);
                        ...
                        bytesRemaining = (bit<19>)bytes_int;
                }
